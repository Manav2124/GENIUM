        ...
        <div className="py-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-secondary text-secondary-foreground py-3 px-4 rounded-lg hover:bg-secondary/80 transition-colors font-medium flex items-center justify-center space-x-2 shadow-md"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="bg-black rounded-2xl shadow-2xl max-w-md w-full mx-auto py-4 relative">
      ...
      <div className="mt-4 text-center">
        ...
        <div className="mt-4 space-y-3">
          <button onClick={() => signIn('google')} className="w-full inline-flex items-center justify-center py-2 px-4 border border-gray-700 rounded-xl bg-black text-white font-medium hover:bg-gray-700 transition-colors">
