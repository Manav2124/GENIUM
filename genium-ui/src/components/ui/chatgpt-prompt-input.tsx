  ...
  <DialogPortal>
    ...
    >
      <div className="relative bg-card dark:bg-[#303030] rounded-[28px] overflow-hidden shadow-2xl p-1">
        {children}
        <DialogPrimitive.Close className="absolute right-3 top-3 z-10 rounded-full bg-background/50 dark:bg-gray-700 p-1 hover:bg-accent dark:hover:bg-gray-600 transition-all">
        ...
        <Dialog open={isImageDialogOpen} onOpenChange={setIsImageDialogOpen}>
          ...
          <div className="relative mb-1 w-fit rounded-[1rem] px-1 pt-1">
            ...
            <button
              ...
              className="absolute right-2 top-2 z-10 flex h-4 w-4 items-center justify-center rounded-full bg-white/50 dark:bg-gray-700 text-black dark:text-white transition-colors hover:bg-accent dark:hover:bg-gray-600"
