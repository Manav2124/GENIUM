...
const ThemeSwitcher = dynamic(() => import('../src/components/ThemeSwitcher'), { ssr: false });
const Profile = dynamic(() => import('../src/components/Profile'), { ssr: false });
const WrapButton = dynamic(() => import('../src/components/ui/wrap-button'), { ssr: false });
const PricingSection = dynamic(() => import('../src/components/ui/pricing.tsx').then(mod => ({ default: mod.PricingSection })), { ssr: false });
const AiInputSearch = dynamic(() => import('../src/components/ui/ai-input.tsx'), { ssr: false });
const Footer = dynamic(() => import('../src/components/Footer'), { ssr: false });
const CardFlip = dynamic(() => import('../src/components/CardFlip'), { ssr: false });
const CodeModal = dynamic(() => import('../src/components/CodeModal'), { ssr: false });
const CodeAssistancePage = dynamic(() => import('../src/components/CodeAssistancePage'), { ssr: false });
const FileUpload = dynamic(() => import('../src/components/FileUpload'), { ssr: false });
const PrivacySection = dynamic(() => import('../src/components/PrivacySection'), { ssr: false });
const DocsPage = dynamic(() => import('../src/components/DocsPage'), { ssr: false });
const AITextLoading = dynamic(() => import('../src/components/ui/ai-text-loading'), { ssr: false });
const AuthCard = dynamic(() => import('../src/components/AuthCard'), { ssr: false });
const Dialog = dynamic(() => import('../src/components/ui/dialog').then(mod => mod.Dialog), { ssr: false });
const DialogContent = dynamic(() => import('../src/components/ui/dialog').then(mod => mod.DialogContent), { ssr: false });
const DialogTrigger = dynamic(() => import('../src/components/ui/dialog').then(mod => mod.DialogTrigger), { ssr: false });
const DialogHeader = dynamic(() => import('../src/components/ui/dialog').then(mod => mod.DialogHeader), { ssr: false });
const DialogTitle = dynamic(() => import('../src/components/ui/dialog').then(mod => mod.DialogTitle), { ssr: false });
const LiquidButton = dynamic(() => import('../src/components/ui/liquid-glass-button').then(mod => ({ default: mod.LiquidButton })), { ssr: false });
import { FileUp, Landmark, ShieldCheck, Zap, Menu, CircleCheckIcon, X, Globe, Download } from 'lucide-react';
import { cn } from '../app/lib/utils';
import { uploadFileToBackend, askDocumentQuestion, askQuestionWithGlobalSearch } from '../src/utils/api'; // Import the API functions
